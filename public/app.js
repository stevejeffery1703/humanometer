...
const QS=[
  ...
  {trait:'empathic',text:"You're in a group conversation and someone makes a point that lands in silence. Nobody responds. You notice the person's expression shift slightly. What are you reading?",opts:[{t:"They felt their point wasn't heard, and they're deciding whether to let it drop or try again",s:4},{t:"I don't read much into silence — people are often just thinking",s:1},{t:"There could be many explanations — I'd need more context to say",s:2},{t:"Something's off — I'd probably find a way to bring their point back in",s:3}]},
